...
export const QUIZ_QUESTIONS = [
...

  {
    ...
    options: [
      ...
      'neat, conscientious, on top of their stuff',
      'extraverted, outgoing, a social butterfly',
      'introverted, loves to stay in, prefers chill events',
      'physically fit, cares about their body',
      'knowledgeable and cultured, intellectually curious',
    ],
  },
  {
    id: 'contact_style',
    category: 'chemistry',
    type: 'mc_single',
    title: "When we're not together, are you a texter or a caller?",
    options: [
  ...
  },
  {
    ...
    type: 'mc_single',
    skippable: true,
    title: 'Assuming you and your partner had great chemistry, how often would you ideally want to have sex?',
    options: [
