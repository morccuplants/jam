...
function Onboarding({ onComplete, onSwitchToLogin }) {
  ...
  async function finish(){
    setError('');setLoading(true);
    try{
      const{token,user}=await apiRegister({email,password,name:name.trim(),age:parseInt(age),gender,seeking,ageMin:parseInt(ageMin),ageMax:parseInt(ageMax),bio:bio.trim(),city});
